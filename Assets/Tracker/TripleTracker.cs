...
public class TripleTracker : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        // create a tracker settings object with variables defined above
        MLMarkerTracker.TrackerSettings trackerSettings = MLMarkerTracker.TrackerSettings.Create(true, MLMarkerTracker.MarkerType.Aruco_April, 0.0762f, d, 0.0762f, profile);
    ...
    private void OnTrackerResultsFound(MLMarkerTracker.MarkerData data)
    {
        ...
        if (!_originFound)
        {
            ...
            Debug.Log("TripleTracker Detected " + id);

            if (id == "2")
            {
                Debug.Log("OriginTracker::0");
